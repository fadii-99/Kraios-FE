            ...
            {turns.map((turn) => (
              ...
              >
                {turn.replies.map((message) => {
                  ...
                  /* A view OF the design — a view-angle version, and whatever
                     preview views the contract grows later — is shown but is
                     not part of the approve/edit workflow: it carries no
                     actions, and it cannot become the render the next
                     instruction refines. */
                  const preview = isPreviewRender(result)
                    ...
                    >
                      {result && (
                        <AssistantResult
                          ...
                          onSelect={preview ? undefined : () => onSelect(result)}
                        />
                      )}
                    </AssistantMessage>
                  )
